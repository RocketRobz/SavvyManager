...
#define SS3ToSS4LipstickAmount 20

// Left: SS3, Right: SS4
static u8 SS3ToSS4LipstickTable[SS3ToSS4LipstickAmount][2] = { // Offset: 0x0A
	{0x0F, 0x2B}, // Jet Black -> Earthen Pink
	{0x15, 0x5E}, // Goldenrod -> Harmonious
	{0x17, 0x40}, // Marmalade -> Enchanting Orange
	{0x1A, 0x60}, // ??? -> Delusion
	{0x1F, 0x08}, // Begonia -> Berry Blast
	{0x20, 0x39}, // Tiramisu -> Rose Confection
	{0x21, 0x12}, // Celebration Pink -> Mulberry Crush
	{0x27, 0x2D}, // Rooibos Tea -> True Love
	{0x28, 0x5B}, // Glamorous Garnet -> Cherry Velvet
	{0x39, 0x6A}, // ??? -> Pearled Rose
	{0x49, 0x71}, // Champagne -> Day Dreamer
	{0x51, 0x0F}, // ??? -> It Girl
	{0x55, 0x1E}, // ??? -> Gluttony
	{0x5A, 0x63}, // ??? -> Mahogany Rose
	{0x64, 0x34}, // Afternoon Rose -> Rose Red
	{0x65, 0x2C}, // Poinsettia -> Passionate Love
	{0x67, 0x02}, // ??? -> Maple Macaroon
	{0x68, 0x07}, // City Pink -> Grape Splash
	{0x6F, 0x37}, // Dusty Roses -> Hidden Thorn
	{0x71, 0x31}, // Hibiscus -> Sundae
};
...
#define SS3ToSS4EyeshadowAmount 27

// Left: SS3, Right: SS4
static u8 SS3ToSS4EyeshadowTable[SS3ToSS4EyeshadowAmount][2] = { // Offset: 0x0C
	{0x02, 0x3D}, // Snow White -> Sapphire
	{0x04, 0x53}, // ??? -> Smooth Chocolate
	{0x0A, 0x18}, // Owl Stone -> Classy Lass
	{0x13, 0x40}, // Blue Lagoon -> Fijian Turquoise
	{0x14, 0x13}, // ??? -> Elderflower Cordial
	{0x15, 0x3B}, // Goldenrod -> Topaz
	{0x17, 0x37}, // Marmalade -> Cool Peach
	{0x1A, 0x4E}, // ??? -> Amethyst Appeal
	{0x1B, 0x56}, // Tabby Grey -> Devilishly Dark
	{0x1C, 0x4B}, // Emerald Ocean -> Polite Society
	{0x21, 0x3E}, // ??? -> Moroccan Red
	{0x23, 0x2B}, // Elegant Rose -> Trembling Flame
	{0x2A, 0x2B}, // ??? -> Trembling Flame
	{0x2B, 0x08}, // ??? -> Buttercream
	{0x31, 0x2F}, // ??? -> Mango Lassi
	{0x32, 0x37}, // Gerbera -> Cool Peach
	{0x34, 0x50}, // ??? -> Fly By Night
	{0x36, 0x43}, // ??? -> Burnished Yellow
	{0x49, 0x18}, // Champagne -> Classy Lass
	{0x5C, 0x3F}, // Sunlight Sand -> India Green
	{0x60, 0x5A}, // Baby Pink -> Angel Eyed
	{0x61, 0x32}, // ??? -> Guava
	{0x69, 0x32}, // Strawberry Pink -> Guava
	{0x6A, 0x39}, // Electric Blue -> Dreamy Blue
	{0x6E, 0x06}, // ??? -> Rose Tea
	{0x71, 0x0E}, // Hibiscus -> Afterparty
	{0x74, 0x29}, // ??? -> Lace Handkerchief
};
...
#define SS3ToSS4ContactAmount 24
...
static u8 SS3ToSS4ContactTable[SS3ToSS4ContactAmount][2] = { // Offset: 0x0E
	...
	{0x31, 0x12},
	{0x38, 0x4C}, // Garden Gate -> Moss Green
	{0x46, 0x1D},
	{0x55, 0x3F},
