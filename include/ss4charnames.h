...
const char* ss4CharacterNames[] = {
	...
	"Erisa (Dupe #1)",
	"Saya (Dupe #1)",
	"Erisa (Dupe #2)", // Used in Concert Hall: Radiance
	"Saya (Dupe #2)", // Used in Concert Hall: Radiance
	"Zayna", // Unseen
	"Niamh", // FF, Unseen
	"Mimi", // Unseen
	"Flavia", // Unseen
